...
public class MybatisController {
	...
	public String write(Model model, HttpSession session,
		...
		session 영역에 해당 속성이 없다면 로그아웃 상태이므로 로그인 페이지로 이동한다.*/
	...
	public ModelAndView loginAction(HttpSession session, HttpServletRequest req) {
	...
	public String writeAction(Model model, HttpSession session, HttpServletRequest req) {
